...
from simulation_linear_2 import *
from simulation_linear_4 import *
from simulation_linear_retro_4 import *
from simulation_linear_6 import *
from simulation_linear_retro_6 import *
from simulation_logistic_5 import *
from simulation_logistic_5_small import *
from simulation_logistic_retro_5 import *
from simulation_logistic_7 import *
from simulation_logistic_retro_7 import *
from simulation_logistic_11 import *
from simulation_logistic_11_followup import *
from simulation_logistic_13 import *
from simulation_ar_1d_reg_0 import *
from simulation_ar_2d_reg_1 import *
from simulation_ar_2d_reg_2 import *
from simulation_ar_2d_reg_retro_2 import *
from simulation_ar_2d_cla_1 import *
from simulation_ar_2d_cla_2 import *
from simulation_ar_2d_cla_3 import *
from simulation_ar_2d_cla_retro_2 import *
from simulation_real_img_reg import *
from simulation_real_img_reg_retro import *
from simulation_real_img_reg_prosp import *
from simulation_real_img_reg_prosp_multi_images import *
from simulation_real_img_reg_prosp_multi_images_large_scale_sim import *
from simulation_CNN_cla import *
from concept_drift_credit_risk import *
from concept_drift_bike_sharing_keras_reg import *
from concept_drift_bike_sharing_norm_keras_reg import *
from concept_drift_bike_sharing_numerical_keras_reg import *
from concept_drift_bike_sharing_norm_numerical_keras_reg import *
from concept_drift_bike_sharing_keras_reg_exp import *

from simulation_nnet_reg_materials import *
from simulation_PI_PII_nnet_reg_materials import *
from simulation_PI_PII_nnet_cla_materials import *

from simulations.multi_logis_cla_find_gamma import *
from simulations.multi_logis_cla import *
# from simulations.multi_logis_cla_rev import *
from simulations.logis_cla_find_gamma import *
from simulations.logis_cla import *
# from simulations.logis_cla_rev import *

from simulations.lin_reg_find_gamma import *
from simulations.lin_reg import *
from simulations.pois_reg_find_gamma import *
from simulations.pois_reg import *

# from simulations.agg_data import *
...
def main(_):
    # cv_find_gamma_task = (0, FLAGS.rand_seed, FLAGS)
    # if FLAGS.model_idx==0:
    #     # Logistic
    #     logis_cla_find_gamma(cv_find_gamma_task) # Cross-validation and find gamma
    #     # Repeat the process of finding gamma without cross-validation.
    #     if FLAGS.cv_flag:
    #         FLAGS.cv_flag = False
    #     find_gamma_tasks = [(i+1, FLAGS.rand_seed+i+1, FLAGS) for i in range(FLAGS.N_rep_find_gamma)]
    #     with parallel_backend('loky', n_jobs=FLAGS.cv_n_jobs):
    #         find_gamma = Parallel(verbose=100,  pre_dispatch='2*n_jobs')(
    #             delayed(logis_cla_find_gamma)(task) for task in find_gamma_tasks)
    # elif FLAGS.model_idx==1:
    #     # Multi-nomial
    #     multi_logis_cla_find_gamma(cv_find_gamma_task) # Cross-validation and find gamma
    #     # Repeat the process of finding gamma without cross-validation.
    #     if FLAGS.cv_flag:
    #         FLAGS.cv_flag = False
    #     find_gamma_tasks = [(i+1, FLAGS.rand_seed+i+1, FLAGS) for i in range(FLAGS.N_rep_find_gamma)]
    #     with parallel_backend('loky', n_jobs=FLAGS.cv_n_jobs):
    #         find_gamma = Parallel(verbose=100,  pre_dispatch='2*n_jobs')(
    #             delayed(multi_logis_cla_find_gamma)(task) for task in find_gamma_tasks)
    # elif FLAGS.model_idx==2:
    #     # Linear
    #     lin_reg_find_gamma(cv_find_gamma_task) # Cross-validation and find gamma
    #     # Repeat the process of finding gamma without cross-validation.
    #     if FLAGS.cv_flag:
    #         FLAGS.cv_flag = False
    #     find_gamma_tasks = [(i+1, FLAGS.rand_seed+i+1, FLAGS) for i in range(FLAGS.N_rep_find_gamma)]
    #     with parallel_backend('loky', n_jobs=FLAGS.cv_n_jobs):
    #         find_gamma = Parallel(verbose=100,  pre_dispatch='2*n_jobs')(
    #             delayed(lin_reg_find_gamma)(task) for task in find_gamma_tasks)
    # elif FLAGS.model_idx==3:
    #     # Poisson
    #     pois_reg_find_gamma(cv_find_gamma_task) # Cross-validation and find gamma
    #     # Repeat the process of finding gamma without cross-validation.
    #     if FLAGS.cv_flag:
    #         FLAGS.cv_flag = False
    #     find_gamma_tasks = [(i+1, FLAGS.rand_seed+i+1, FLAGS) for i in range(FLAGS.N_rep_find_gamma)]
    #     with parallel_backend('loky', n_jobs=FLAGS.cv_n_jobs):
    #         find_gamma = Parallel(verbose=100,  pre_dispatch='2*n_jobs')(
    #             delayed(pois_reg_find_gamma)(task) for task in find_gamma_tasks)
    #
    # Agg_Gamma_Data(FLAGS)

    # multi_logis_cla_find_gamma(task)
    # lin_reg_find_gamma(task)
    # pois_reg_find_gamma(task)

    if FLAGS.single_exp_plot == 2: #
        simulation_linear_2(FLAGS)
    elif FLAGS.single_exp_plot == 4: #
        simulation_linear_4(FLAGS)
    elif FLAGS.single_exp_plot == 44:
        simulation_linear_retro_4(FLAGS)
    elif FLAGS.single_exp_plot == 6: #
        simulation_linear_6(FLAGS)
    elif FLAGS.single_exp_plot == 66:
        simulation_linear_retro_6(FLAGS)
    elif FLAGS.single_exp_plot == 5: #
        simulation_logistic_5(FLAGS)
    elif FLAGS.single_exp_plot == 50: #
        simulation_logistic_5_small(FLAGS)
    elif FLAGS.single_exp_plot == 55:
        simulation_logistic_retro_5(FLAGS)
    elif FLAGS.single_exp_plot == 7: #
        simulation_logistic_7(FLAGS)
    elif FLAGS.single_exp_plot == 77:
        simulation_logistic_retro_7(FLAGS)
    elif FLAGS.single_exp_plot == 11: #
        simulation_logistic_11(FLAGS)
    elif FLAGS.single_exp_plot == 111: #
        simulation_logistic_11_followup(FLAGS)
    elif FLAGS.single_exp_plot == 13:
        simulation_logistic_13(FLAGS)
    elif FLAGS.single_exp_plot == 21:
        simulation_ar_1d_reg_0(FLAGS)
    elif FLAGS.single_exp_plot == 23:
        simulation_ar_2d_reg_1(FLAGS)
    elif FLAGS.single_exp_plot == 25:
        simulation_ar_2d_reg_2(FLAGS)
    elif FLAGS.single_exp_plot == 2525:
        simulation_ar_2d_reg_retro_2(FLAGS)
    elif FLAGS.single_exp_plot == 22:
        simulation_ar_2d_cla_1(FLAGS)
    elif FLAGS.single_exp_plot == 24:
        simulation_ar_2d_cla_2(FLAGS)
    elif FLAGS.single_exp_plot == 31:
        simulation_real_img_reg(FLAGS)
    elif FLAGS.single_exp_plot == 26:
        simulation_ar_2d_cla_3(FLAGS)
    elif FLAGS.single_exp_plot == 2424:
        simulation_ar_2d_cla_retro_2(FLAGS)
    elif FLAGS.single_exp_plot == 3131:
        simulation_real_img_reg_retro(FLAGS)
    elif FLAGS.single_exp_plot == 313131:
        simulation_real_img_reg_prosp(FLAGS)
    elif FLAGS.single_exp_plot == 31313131:
        simulation_real_img_reg_prosp_multi_images(FLAGS)
    elif FLAGS.single_exp_plot == 3131313100:
        simulation_real_img_reg_prosp_multi_images_large_scale_sim(FLAGS)
    elif FLAGS.single_exp_plot == -1: #
        credit_risk(FLAGS)
    elif FLAGS.single_exp_plot == -2:
        simulation_PI_PII_nnet_reg_materials(FLAGS)
    elif FLAGS.single_exp_plot == -3:
        simulation_PI_PII_nnet_cla_materials(FLAGS)
    elif FLAGS.single_exp_plot == -4:
        bike_sharing(FLAGS)
    elif FLAGS.single_exp_plot == -44:
        bike_sharing_norm(FLAGS)
    elif FLAGS.single_exp_plot == -444:
        bike_sharing_numerical(FLAGS)
    elif FLAGS.single_exp_plot == -4444:
        bike_sharing_norm_numerical(FLAGS)
    elif FLAGS.single_exp_plot == -40:
        bike_sharing_exp(FLAGS)
    elif FLAGS.single_exp_plot == -10:
        simulation_CNN_cla(FLAGS)
